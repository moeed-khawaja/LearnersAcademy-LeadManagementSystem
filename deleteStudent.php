...
<div class="search_c">
    <form method="post" action="deleteStudent.php" id="searchForm">
...
$count = -1;
    ...
    $sqlName = "SELECT CONCAT(First_Name, ' ', Last_Name) as name, Lead_id, Standard, Email, Phone, Mode, Subject, Notes, Category_ID, Gender FROM Lead_Entity WHERE (First_Name LIKE '%$search%' OR Last_Name LIKE '%$search%') AND sale_status = 0";
...
?>
    ...
    if (isset($_POST['deleteButton'])) {
        ...
        $sql= "DELETE FROM Lead_entity WHERE Lead_id= $idToDelete";
